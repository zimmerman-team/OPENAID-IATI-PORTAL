...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {	
		...
		wp_register_script( 'angular-leaflet-directive', get_stylesheet_directory_uri() . '/bower_components/angular-leaflet-directive/dist/angular-leaflet-directive.min.js', array(), '', true);
